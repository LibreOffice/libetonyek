...
#ifndef KNXMLREADERTEST_H_INCLUDED
#define KNXMLREADERTEST_H_INCLUDED
...
class KNXMLReaderTest : public CPPUNIT_NS::TestFixture
{
public:
  virtual void setUp();
...
private:
  CPPUNIT_TEST_SUITE(KNXMLReaderTest);
...
#endif // KNXMLREADERTEST_H_INCLUDED
