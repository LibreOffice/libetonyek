...
#ifndef KNSHAPETEST_H_INCLUDED
#define KNSHAPETEST_H_INCLUDED
...
class KNShapeTest : public CPPUNIT_NS::TestFixture
{
public:
  virtual void setUp();
...
private:
  CPPUNIT_TEST_SUITE(KNShapeTest);
