...
#ifndef IWORKTEXTREDIRECTOR_H_INCLUDED
#define IWORKTEXTREDIRECTOR_H_INCLUDED
...
class IWORKTextRedirector : public IWORKDocumentInterface
{
public:
...
#endif // IWORKTEXTREDIRECTOR_H_INCLUDED
