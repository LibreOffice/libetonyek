...
void drawMedia(const IWORKMediaPtr_t &media, const glm::mat3 &trafo, IWORKOutputElements &elements)
{
  if (bool(media)
      ...
      && bool(media->m_content->m_data->m_stream))
  {
    ...
    if (mimetype)
    {
      ...
      vec = trafo * glm::vec3(width, height, 0);
...
void drawImage(const IWORKImagePtr_t &image, const glm::mat3 &trafo, IWORKOutputElements &elements)
{
  // TODO: implement me
  (void) image;
  (void) trafo;
...
void drawLine(const IWORKLinePtr_t &line, const glm::mat3 &trafo, IWORKOutputElements &elements)
{
...
void drawShape(const IWORKShapePtr_t &shape, const glm::mat3 &trafo, IWORKOutputElements &elements)
{
...
void drawTable(const IWORKTable &table, const glm::mat3 &trafo, IWORKOutputElements &elements)
{
