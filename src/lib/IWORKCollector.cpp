...
void IWORKCollector::collectTableCell(const unsigned row, const unsigned column, const boost::optional<std::string> &content, const unsigned rowSpan, const unsigned columnSpan, const boost::optional<IWORKFormula> &formula, const boost::optional<IWORKTableNameMap_t> &tableNameMap)
{
  ...
  m_currentTable.insertCell(column, row, elements, columnSpan, rowSpan, formula, tableNameMap);
}
