...
void IWORKCollector::collectTableCell(const unsigned row, const unsigned column, const boost::optional<std::string> &content, const unsigned rowSpan, const unsigned columnSpan, const boost::optional<IWORKFormula> &formula, const IWORKStylePtr_t &style, const unsigned type)
{
