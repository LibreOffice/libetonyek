...
{
public:
  IWORKStyleContext(IWORKXMLParserState &state, IWORKStyleMap_t *style, bool nested = false);
  IWORKStyleContext(IWORKXMLParserState &state, IWORKStyleMap_t *style, IWORKPropertyMap &props, bool nested = false);
