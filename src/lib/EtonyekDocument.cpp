...
typedef bool (*ProbeXMLFun_t)(const RVNGInputStreamPtr_t &, unsigned &, const xmlTextReaderPtr &);
...
bool probeKeynote1XML(const RVNGInputStreamPtr_t &input, unsigned &version, const xmlTextReaderPtr &reader)
{
  // TODO: implement me
  (void) input;
  (void) version;
...
bool probeKeynote2XML(const RVNGInputStreamPtr_t &input, unsigned &version, const xmlTextReaderPtr &reader)
{
  if (input->isEnd())
    return false;
...
bool probeKeynoteXML(const RVNGInputStreamPtr_t &input, unsigned &version, const xmlTextReaderPtr &reader)
{
...
bool probeNumbersXML(const RVNGInputStreamPtr_t &input, unsigned &version, const xmlTextReaderPtr &reader)
{
  if (input->isEnd())
    return false;
...
bool probePagesXML(const RVNGInputStreamPtr_t &input, unsigned &version, const xmlTextReaderPtr &reader)
{
  if (input->isEnd())
    return false;
...
{
  const shared_ptr<xmlTextReader> reader = shared_ptr<xmlTextReader>(xmlReaderForIO(readFromStream, closeStream, input.get(), "", 0, 0), xmlFreeTextReader);
  if (!bool(reader.get()))
    return false;
