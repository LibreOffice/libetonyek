...
#ifndef KNSTYLECONTEXT_H_INCLUDED
#define KNSTYLECONTEXT_H_INCLUDED
...
/** Representation of a dynamic inheritance of styles.
  ...
  *
  * The property getters in specific implementations of @c KNStyle
  * should take a pointer to a @c KNStyleContext.
  */
class KNStyleContext
{
  /** The internal type of style stack.
    ...
    */
  typedef std::deque<KNStylePtr_t> Stack_t;
...
public:
  ...
  /** Push a style onto the active styles stack.
    ...
    */
  void push(const KNStylePtr_t &style);
...
#endif // KNSTYLECONTEXT_H_INCLUDED
