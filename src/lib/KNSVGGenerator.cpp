...
libkeynote::KNSVGGenerator::KNSVGGenerator(libkeynote::KNStringVector &vec): m_gradient(), m_style(), m_gradientIndex(1), m_patternIndex(1), m_shadowIndex(1), m_outputSink(), m_vec(vec)
{
}

libkeynote::KNSVGGenerator::~KNSVGGenerator()
{
}

void libkeynote::KNSVGGenerator::startGraphics(const WPXPropertyList &propList)
{
...
void libkeynote::KNSVGGenerator::endGraphics()
{
...
void libkeynote::KNSVGGenerator::setStyle(const ::WPXPropertyList &propList, const ::WPXPropertyListVector &gradient)
{
  m_style.clear();
  m_style = propList;
...
void libkeynote::KNSVGGenerator::startLayer(const ::WPXPropertyList &propList)
{
...
void libkeynote::KNSVGGenerator::endLayer()
{
  m_outputSink << "</svg:g>\n";
}

void libkeynote::KNSVGGenerator::drawRectangle(const ::WPXPropertyList &propList)
{
...
void libkeynote::KNSVGGenerator::drawEllipse(const WPXPropertyList &propList)
{
...
void libkeynote::KNSVGGenerator::drawPolyline(const ::WPXPropertyListVector &vertices)
{
  drawPolySomething(vertices, false);
}

void libkeynote::KNSVGGenerator::drawPolygon(const ::WPXPropertyListVector &vertices)
{
  drawPolySomething(vertices, true);
}

void libkeynote::KNSVGGenerator::drawPolySomething(const ::WPXPropertyListVector &vertices, bool isClosed)
{
  if(vertices.count() < 2)
    return;
...
void libkeynote::KNSVGGenerator::drawPath(const ::WPXPropertyListVector &path)
{
...
void libkeynote::KNSVGGenerator::drawGraphicObject(const ::WPXPropertyList &propList, const ::WPXBinaryData &binaryData)
{
...
void libkeynote::KNSVGGenerator::startTextObject(const ::WPXPropertyList &propList, const ::WPXPropertyListVector & /* path */)
{
...
void libkeynote::KNSVGGenerator::endTextObject()
{
  m_outputSink << "</svg:text>\n";
}

void libkeynote::KNSVGGenerator::startTextSpan(const ::WPXPropertyList &propList)
{
...
void libkeynote::KNSVGGenerator::endTextSpan()
{
  m_outputSink << "</svg:tspan>\n";
}

void libkeynote::KNSVGGenerator::insertText(const ::WPXString &str)
{
...
void libkeynote::KNSVGGenerator::writeStyle(bool /* isClosed */)
{
  m_outputSink << "style=\"";
