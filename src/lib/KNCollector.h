...
public:
  ...
  virtual void collectFiltered(const boost::optional<ID_t> &id, const boost::optional<KNSize> &size) = 0;
  virtual void collectLeveled(const boost::optional<ID_t> &id, const boost::optional<KNSize> &size) = 0;
