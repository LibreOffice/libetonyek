...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 libetonyek-0.0.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /machine:IX86 /out:"Release\bin\key2xhtml.exe" /libpath:"Release\lib"
# ADD LINK32 libetonyek-0.0.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /machine:IX86 /out:"Release\bin\key2xhtml.exe" /libpath:"Release\lib"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 libetonyek-0.0.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /debug /machine:IX86 /out:"Debug\bin\key2xhtml.exe" /libpath:"Debug\lib"
# ADD LINK32 libetonyek-0.0.lib libwpd-stream-0.9.lib libwpd-0.9.lib /nologo /subsystem:console /debug /machine:IX86 /out:"Debug\bin\key2xhtml.exe" /libpath:"Debug\lib"
# SUBTRACT LINK32 /nodefaultlib
